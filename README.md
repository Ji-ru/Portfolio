# Jibril Rubi - IT Student & Developer Portfolio

A modern, responsive portfolio website showcasing my projects, skills, and experience as an fresh IT graduate.

## 🌐 Live Website
[Visit Portfolio](https://example.com) *(Update with your actual domain)*
...
1. **Fuller-Based English Reading Mobile App** (Capstone Project)
   ...
   - React Native, 3rd party Speech Recognition Model, Firebase
...
2. **Tuklas: Philippine Travel Itinerary & Exploration Platform** (Full Stack Web App)
   ...
   - React, TypeScript, Vite, Tailwind CSS, AI Travel Assistant
   - Custom itineraries, island exploration, and AI chat companion
...
This portfolio is created for personal use. Feel free to use as a template.

## 🤝 Contributing

This is a personal portfolio. For suggestions or improvements, please create an issue or reach out directly.
